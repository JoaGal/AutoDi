  ...
  return (
    <main>
      ...
      <div className="flex justify-center items-center pt-10 md:pt-0">
        <Link
          href="/"
          className="text-3xl md:text-5xl font-bold text-center text-stone-50 bg-lime-500 p-2 pb-3 md:p-6 md:pb-7 shadow-lg rounded-lg drop-shadow-lg animate__animated animate__bounceInDown z-20"
        >
          Comenzar
        </Link>
      </div>
