...
export const SelectStatsCard = ({pathObject, handleChange}: SelectHome) => {
    return (
        ...
        <select value={pathObject} onChange={handleChange} name='activity' id='activity' className='shadow-lg drop-shadow-lg text-lime-500 md:h-10 p-2 rounded-sm bg-stone-50 text-sm md:text-lg outline-none md:mt-0 hover:bg-lime-100'>
